...
@Mapper(uses = {DateMapper.class, ContractOrderLineMapper.class})
public interface ContractOrderMapper {

    ContractOrderDto contractOrderToDto(ContractOrder contractOrder);

    ContractOrder dtoToContractOrder(ContractOrderDto dto);
