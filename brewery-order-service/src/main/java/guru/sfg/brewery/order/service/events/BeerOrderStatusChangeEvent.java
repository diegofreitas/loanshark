...
public class ContractOrderStatusChangeEvent extends ApplicationEvent {

    private final OrderStatusEnum previousStatus;

    public ContractOrderStatusChangeEvent(ContractOrder source, OrderStatusEnum previousStatus) {
        super(source);
    ...
    public ContractOrder getContractOrder(){
        return (ContractOrder) this.source;
    }
}
