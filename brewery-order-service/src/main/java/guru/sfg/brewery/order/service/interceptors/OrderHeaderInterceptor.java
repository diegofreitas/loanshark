...
import guru.sfg.brewery.order.service.events.ContractOrderStatusChangeEvent;
...
public class OrderHeaderInterceptor extends EmptyInterceptor {
    ...
    public boolean onFlushDirty(Object entity, Serializable id, Object[] currentState, Object[] previousState, String[] propertyNames, Type[] types) {
        ...
        if (entity instanceof ContractOrder){
                    ...
                    for (Object prevObj : previousState){
                        if (prevObj instanceof OrderStatusEnum) {
                            ...
                            if(curStatus != prevStatus){
                                ...
                                publisher.publishEvent(new ContractOrderStatusChangeEvent((ContractOrder) entity, prevStatus));
                            }
                        }
                    }
                }
